...
train_args.add_argument('-i', '--num-iterations', type=int, default=100000,
...
train_args.add_argument('--save-freq', type=int, default=2500,
...
train_args.add_argument('--eval-freq', type=int, default=15000,
